...
class LoginSignupPage:
    def __init__(self, root):
        ...
        self.bg_image = Image.open(r"C:\Users\ASUS\Desktop\ExpenseMate\pexels-njeromin-14760650-Photoroom.png")  # Replace with your image path
...
class Dashboard:
    def __init__(self, email):
        ...
        self.bg_image = Image.open(r"C:\Users\ASUS\Desktop\ExpenseMate\pexels-davis-vidal-24041114-8465932.jpg")
        self.bg_image = self.bg_image.resize((1540, 900))
        self.bg_photo = ImageTk.PhotoImage(self.bg_image)
